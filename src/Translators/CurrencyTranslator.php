...
class CurrencyTranslator extends AbstractTranslator implements Accessible, Translatable
{
    public function __construct(
        ...
        $this->path = $path ?? realpath(__DIR__."/../../translations/$language/currencies.json");
